    ...
    [ShareSDK share:platformType parameters:shareParams onStateChanged:^(SSDKResponseState state, NSDictionary *userData, SSDKContentEntity *contentEntity, NSError *error) {
        switch (state) {
            ...
            case SSDKResponseStateSuccess:
                [WebViewJSBundle callJS:callbackId code:0 params:[NSArray arrayWithObjects:@"分享成功",nil]];
                break;
                //分享失败
            case SSDKResponseStateFail:
                [WebViewJSBundle callJS:callbackId code:1 params:[NSArray arrayWithObjects:@"分享失败",nil]];
                break;
                //分享取消
            case SSDKResponseStateCancel:
                [WebViewJSBundle callJS:callbackId code:1 params:[NSArray arrayWithObjects:@"分享取消",nil]];
                break;
            default:
                break;
        }
